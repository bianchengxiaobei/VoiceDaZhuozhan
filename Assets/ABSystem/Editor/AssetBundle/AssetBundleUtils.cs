...
namespace Tangzx.ABSystem
{
    ...
    class AssetBundleUtils
    {
        ...
        public static void LoadCache()
        {
            ...
            if (File.Exists(cacheTxtFilePath))
            {
                ...
                try
                {
                    ...
                    wrongVer = ver.Minor < WWWResourceManager.version.Minor || ver.Major < WWWResourceManager.version.Major;
                }
        ...
        public static void SaveCache()
        {
            ...
            sw.WriteLine(WWWResourceManager.version.ToString());
        ...
        public static void SaveResourceIndexInfo()
        {
            StreamWriter sw = new StreamWriter(pathResolver.BundleIndexInfoSavePath);
            //sw.WriteLine(WWWResourceManager.version.ToString());
            foreach (AssetTarget target in _object2target.Values)
            {
                target.WriteIndexInfo(sw);
            }
            sw.Flush();
            sw.Close();
        }
