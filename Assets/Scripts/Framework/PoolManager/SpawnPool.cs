...
namespace CaomaoFramework
{
    ...
    public sealed class SpawnPool : MonoBehaviour, IList<Transform>
    {
        ...
        public Transform Spawn(Transform prefab)
        {
            ...
            return this.Spawn(prefab, prefab.position, prefab.rotation);
        }
    ...
    public class PrefabPool
    {
        ...
        public Transform SpawnNew(Vector3 pos, Quaternion rot)
        {
            ...
            if (pos == Vector3.zero) pos = this.prefabGO.transform.position;
            if (rot == Quaternion.identity) rot = this.prefabGO.transform.rotation;
